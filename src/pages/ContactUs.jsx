...
const ContactUs = () => {
  ...
  return (
    <div className='flex flex-col space-y-10 items-center justify-center w-screen h-auto relative py-10'>
      <div className='w-full lg:w-[90%] px-5 lg:px-0 flex flex-col space-y-5 pb-10 pt-10 justify-center items-center'>
        <img
          src={aboutUsVector}
          alt='about us vector'
        ...
        <div className='flex flex-col space-y-5'>
          ...
          <p className='text-[20px] leading-[40px] text-center text-[#667085]'>
