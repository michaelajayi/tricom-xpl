...
const OurTeam = () => {
  ...
  return (
    <div className='flex flex-col space-y-10 items-center justify-center w-screen h-auto relative py-10'>
      <div className='w-full lg:w-[90%] px-5 lg:px-0 flex flex-col space-y-5 pb-10 pt-10 justify-start items-start'>
        <img
          src={aboutUsVector}
          alt='about us vector'
        ...
        <div className='flex flex-col space-y-5 w-full md:w-[80%] lg:w-[90%]'>
          ...
          {/* our team slider */}
          <div className="py-5 lg:py-20 w-full md:w-[90%] px-5 md:px-0">
            <OurTeamSlider />
          </div>
        </div>
      </div>
